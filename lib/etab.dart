...
/// See also:
///
///  * [ETabBar], which displays a row of tabs.
///  * [ETabBarView], which displays a widget for the currently selected tab.
///  * [ETabBar.indicator], which defines the appearance of the selected tab
///    indicator relative to the tab's bounds.
enum ETabBarIndicatorSize {
  ...
  ///
  /// This value is used to align the tab's label, typically a [ETab]
  /// widget's text or icon, with the selected tab indicator.
  label,
}

/// A material design [ETabBar] tab.
///
...
///  * [ETabBar], which displays a row of tabs.
///  * [ETabBarView], which displays a widget for the currently selected tab.
///  * [TabController], which coordinates tab selection between a [ETabBar] and a [ETabBarView].
///  * <https://material.io/design/components/tabs.html>
class ETab extends StatelessWidget {
  /// Creates a material design [ETabBar] tab.
  ///
...
double _indexChangeProgress(TabController controller) {
  ...
  // ETabBarView's PageView to the left or right.
...
class _IndicatorPainter extends CustomPainter {
  ...
  final ETabBarIndicatorSize indicatorSize;
  ...
  Rect indicatorRect(Size tabBarSize, int tabIndex) {
    ...
    if (indicatorSize == ETabBarIndicatorSize.label) {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    if (controller.indexIsChanging) {
      ...
      // The user is dragging the ETabBarView's PageView left or right.
...
// where a scrollable ETabBar has a non-zero initialIndex. In that case we can
// only compute the scroll position's initial scroll offset (the "correct"
// pixels value) after the ETabBar viewport width and scroll limits are known.
...
// where a scrollable ETabBar has a non-zero initialIndex.
...
/// See also:
///
///  * [ETabBarView], which displays page views that correspond to each tab.
class ETabBar extends StatefulWidget implements PreferredSizeWidget {
  ...
  /// Typically a list of two or more [ETab] widgets.
  ///
  /// The length of this list must match the [controller]'s [TabController.length]
  /// and the length of the [ETabBarView.children] list.
  ...
  /// and the entire [ETabBar] is scrollable. Otherwise each tab gets an equal
  ...
  /// the indicator with the tab's text for [ETab] widgets and all but the
  /// shortest [ETab.text] values.
  ///
  ...
  /// is [ETabBarIndicatorSize.tab] the tab's bounds are as wide as the space
  /// occupied by the tab in the tab bar. If [indicatorSize] is
  /// [ETabBarIndicatorSize.label], then the tab's bounds are only as wide as
  ...
  /// tab's overall bounds if [indicatorSize] is [ETabBarIndicatorSize.tab]
  /// (the default) or relative to the bounds of the tab's widget if
  /// [indicatorSize] is [ETabBarIndicatorSize.label].
  ///
  ...
  /// An optional callback that's called when the [ETabBar] is tapped.
  ///
  /// The callback is applied to the index of the tab where the tap occurred.
  ///
  /// This callback has no effect on the default handling of taps. It's for
  /// applications that want to do a little extra work when a tab is tapped,
  /// even if the tap doesn't change the TabController's index. ETabBar [onTap]
...
class _TabBarState extends State<ETabBar> {
  ...
  // If the ETabBar is rebuilt with a new tab controller, the caller should
  ...
  @override
  void didUpdateWidget(ETabBar oldWidget) {
  ...
  void _handleTabControllerAnimationTick() {
    ...
    if (!_controller.indexIsChanging && widget.isScrollable) {
      // Sync the ETabBar's scroll position with the ETabBarView's PageView.
      _currentIndex = _controller.index;
    ...
    assert(() {
      if (_controller.length != widget.tabs.length) {
        throw FlutterError(
            ...
            'number of tabs (${widget.tabs.length}) present in ETabBar\'s tabs property.');
      }
      return true;
    }());
...
/// selected tab.
///
/// This widget is typically used in conjunction with a [ETabBar].
///
/// If a [TabController] is not provided, then there must be a [DefaultTabController]
/// ancestor.
///
/// The tab controller's [TabController.length] must equal the length of the
/// [children] list and the length of the [ETabBar.tabs] list.
///
/// To see a sample implementation, visit the [TabController] documentation.
class ETabBarView extends StatefulWidget {
  ...
  /// One widget per tab.
  ///
  /// Its length must match the length of the [ETabBar.tabs]
...
class _TabBarViewState extends State<ETabBarView> {
  TabController _controller;
  ...
  // If the ETabBarView is rebuilt with a new tab controller, the caller should
  // dispose the old one. In that case the old controller's animation will be
  // null and should not be accessed.
  bool get _controllerIsValid => _controller?.animation != null;
  ...
  @override
  void didUpdateWidget(ETabBarView oldWidget) {
    super.didUpdateWidget(oldWidget);
  ...
  Widget build(BuildContext context) {
    assert(() {
      if (_controller.length != widget.children.length) {
        throw FlutterError(
            'Controller\'s length property (${_controller.length}) does not match the \n'
            'number of tabs (${widget.children.length}) present in ETabBar\'s tabs property.');
      }
      return true;
    }());
...
class TabPageSelector extends StatelessWidget {
  ...
  Widget _buildTabIndicator(
    ...
    if (tabController.indexIsChanging) {
      ...
      // The selection's offset reflects how far the ETabBarView has / been dragged
